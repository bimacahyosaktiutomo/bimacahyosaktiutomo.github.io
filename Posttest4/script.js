...
function darkmode() {
    ...
    var comment = document.getElementsByClassName('item-comentar')
    var comment_area = document.getElementsByClassName('coment-area')
    ...
    for (var i = 0; i < comment.length; i++) {
        comment[i].classList.toggle('card-dark-mode');
    }
    for (var i = 0; i < comment_area.length; i++) {
        comment_area[i].classList.toggle('card-dark-mode');
    }
